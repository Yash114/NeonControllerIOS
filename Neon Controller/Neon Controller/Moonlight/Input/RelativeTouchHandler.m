...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    touchMoved = false;
    peakTouchCount = [[event touchesForView:view] count];
    if ([[event touchesForView:view] count] == 1) {
    ...
    else if ([[event touchesForView:view] count] == 2) {
        CGPoint firstLocation = [[[[event touchesForView:view] allObjects] objectAtIndex:0] locationInView:view];
        CGPoint secondLocation = [[[[event touchesForView:view] allObjects] objectAtIndex:1] locationInView:view];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([[event touchesForView:view] count] - [touches count] == 1) {
        NSMutableSet *activeSet = [[NSMutableSet alloc] initWithCapacity:[[event touchesForView:view] count]];
        [activeSet unionSet:[event touchesForView:view]];
